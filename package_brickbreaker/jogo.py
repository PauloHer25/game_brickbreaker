...
def criar_blocos(qtde_blocos_linha, qtde_linhas_blocos):
    ...
    for i in range(qtde_linhas_blocos):
        ...
        for j in range(qtde_blocos_linha):
            #Criar o bloco
            bloco = pygame.Rect(j * (largura_bloco + distancia_entre_blocos), i * distancia_entre_linhas, largura_bloco, altura_bloco)
...
def desenhar_inicio_jogo():
    ...
    pygame.draw.rect(tela, cores["laranja"], jogador)
